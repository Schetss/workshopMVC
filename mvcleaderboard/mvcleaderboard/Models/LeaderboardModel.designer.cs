...
namespace mvcleaderboard.Models
{
	...
	public partial class LeaderboardModelDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertSkillsPerUser(SkillsPerUser instance);
    partial void UpdateSkillsPerUser(SkillsPerUser instance);
    partial void DeleteSkillsPerUser(SkillsPerUser instance);
    #endregion
		
		public LeaderboardModelDataContext() : 
		...
		public LeaderboardModelDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LeaderboardModelDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LeaderboardModelDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LeaderboardModelDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<SkillsPerUser> SkillsPerUsers
		{
			get
			{
				return this.GetTable<SkillsPerUser>();
			}
		}
	}
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SkillsPerUser> _SkillsPerUsers;
    ...
    partial void OnnameChanged();
		...
		public User()
		{
			this._SkillsPerUsers = new EntitySet<SkillsPerUser>(new Action<SkillsPerUser>(this.attach_SkillsPerUsers), new Action<SkillsPerUser>(this.detach_SkillsPerUsers));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MVCUser_MVCSkillsPerUser", Storage="_SkillsPerUsers", ThisKey="id", OtherKey="fk_user_id")]
		public EntitySet<SkillsPerUser> SkillsPerUsers
		{
			get
			{
				return this._SkillsPerUsers;
			}
			set
			{
				this._SkillsPerUsers.Assign(value);
			}
		}
		...
		private void attach_SkillsPerUsers(SkillsPerUser entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_SkillsPerUsers(SkillsPerUser entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
    ...
    partial void OnskillChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MVCSkill_MVCSkillsPerUser", Storage="_SkillsPerUsers", ThisKey="id", OtherKey="fk_skill_id")]
		public EntitySet<SkillsPerUser> SkillsPerUsers
		{
			get
			{
	...
	public partial class SkillsPerUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
			...
			set
			{
							...
							|| (this._Skill.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.SkillsPerUsers.Remove(this);
					}
					this._Skill.Entity = value;
					if ((value != null))
					{
						value.SkillsPerUsers.Add(this);
